                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-3 mx-md-2">
                                    <div class="text-center">
                                        <img src="../Assets/images/logo/cODE cRAFT lOGO.jpg" style="width: 150px" alt="logo" />
                                        <h4 class="mt-1 mb-5 pb-1">Log in to Code Craft</h4>
                                    </div>
                                    <form id="" method="post" action="../Back-end/authenticate.php">
                                        <p>Please login to your account</p>
                                        <div class="form-outline mb-4">
                                            <input type="email" id="form2Example11" class="form-control" placeholder="your registered email" name="lmail" required />
                                            <label class="form-label" for="form2Example11">Email</label>
                                        </div>

                                        <div class="form-outline mb-4">
                                            <input type="password" id="form2Example22" class="form-control" name="lpswd" required />
                                            <label class="form-label" for="form2Example22">Password</label>
                                        </div>

                                        <div class="text-center pt-1 mb-3 pb-1">
                                            <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 col-3" type="submit" id="loginForm">
                                                Log in
                                            </button>
                                        </div>
                                    </form>
